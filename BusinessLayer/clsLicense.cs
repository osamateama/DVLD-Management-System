...
namespace BusinessLayer
{
    public class clsLicense
    {
        ...
        {
            LicenseID = clsLicensesData.AddNewLicense(ApplicationID, DriverID, LicenseClassID,
        ...
        {
            return clsLicensesData.UpdateLicense(LicenseID, ApplicationID, DriverID, LicenseClassID,
                IssueDate, ExpirationDate, Notes, PaidFees, IsActive, (byte) IssueReason, CreatedByUserID);
        }
        ...
        public clsLicense Replace(enIssueReason IssueReason, int CreatedByUserID)
        {
            ...
            Application.ApplicationTypeID = (IssueReason == enIssueReason.DamagedReplacement) ?
                (int)clsApplication.enApplicationType.ReplacementForaDamagedDrivingLicense :(int)clsApplication.enApplicationType.ReplacementForaLostDrivingLicense;
